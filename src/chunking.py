...
class SentenceChunker:
    ...
    def chunk(self, text: str) -> list[str]:
        ...
        # Keep sentence-ending punctuation in the sentence.  New lines also act
        # as boundaries after a full stop, as required by the exercise.
        sentences = [
            sentence.strip()
...
class RecursiveChunker:
    ...
    def _split(self, current_text: str, remaining_separators: list[str]) -> list[str]:
        ...
        # If this separator is not useful, immediately try the next one.
        ...
        for unit in units:
            if len(unit) > self.chunk_size:
                if buffer.strip():
                    ...
                    buffer = ""
                chunks.extend(self._split(unit.strip(), lower_priority_separators))
